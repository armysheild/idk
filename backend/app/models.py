...
class Organization(Base):
    ...
    odometer_max_daily_km: Mapped[int] = mapped_column(Integer, default=1000, nullable=False)
    labor_rate_per_hour: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    safety_contact_name: Mapped[Optional[str]] = mapped_column(String(160))
...
class MaintenanceTemplate(Base):
    ...
    name: Mapped[str] = mapped_column(String(200), nullable=False)
    description: Mapped[Optional[str]] = mapped_column(Text)
    vehicle_type: Mapped[Optional[str]] = mapped_column(String(80), index=True)
    interval_km: Mapped[Optional[int]] = mapped_column(Integer)
    interval_days: Mapped[Optional[int]] = mapped_column(Integer)
